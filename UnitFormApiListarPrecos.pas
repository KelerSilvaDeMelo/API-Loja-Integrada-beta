...
type
  TFormApiListarPrecos = class(TForm)
    LayoutApiListarPreco: TLayout;
    ...
    FDMemTablePreco: TFDMemTable;
    ActionListApiListarPrecos: TActionList;
...
var
  FormApiListarPrecos: TFormApiListarPrecos;
...
{---------------------------------[ INTERNAL ]---------------------------------}
procedure TFormApiListarPrecos.ImageEngrenagemClick(Sender: TObject);
begin
  Self.ActionVoltar.Execute;
end;

{---------------------------------[ ACTION ]-----------------------------------}
procedure TFormApiListarPrecos.ActionRequestExecute(Sender: TObject);
begin
  Self.ExecutaSolicitacaoHttpGet;
end;

procedure TFormApiListarPrecos.ActionVoltarExecute(Sender: TObject);
begin
  Self.LayoutApiListarPreco.Parent := Self;
end;

{---------------------------------[ PRIVATE ]----------------------------------}
procedure TFormApiListarPrecos.ExecutaSolicitacaoHttpGet;
var
...
begin
  ...
  Self.FDMemTablePreco.Active   := False;
...
{---------------------------------[ PUBLIC ]-----------------------------------}
procedure TFormApiListarPrecos.Mostra(Leiaute: TLayout);
begin
  Self.TabControlAPI.ActiveTab      := TabItemListaGrades;
  Self.LayoutApiListarPreco.Parent  := Leiaute;
end;
