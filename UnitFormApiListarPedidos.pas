...
type
  TFormApiListarPedidos = class(TForm)
    LayoutApiPedidos: TLayout;
...
var
  FormApiListarPedidos: TFormApiListarPedidos;
...
{---------------------------------[ INTERNAL ]---------------------------------}
procedure TFormApiListarPedidos.ImageEngrenagemClick(Sender: TObject);
begin
  Self.ActionVoltar.Execute;
end;

{---------------------------------[ ACTION ]-----------------------------------}
procedure TFormApiListarPedidos.ActionRequestExecute(Sender: TObject);
begin
  Self.ExecutaSolicitacaoHttpGet;
end;

procedure TFormApiListarPedidos.ActionVoltarExecute(Sender: TObject);
begin
  Self.LayoutApiPedidos.Parent := Self;
end;

{---------------------------------[ PRIVATE ]----------------------------------}
procedure TFormApiListarPedidos.ExecutaSolicitacaoHttpGet;
var
  BaseURL, UriListarCategorias: string;
  chave, valor: String;
begin
  Self.TabControlAPI.ActiveTab  := Self.TabItemPedidos;
...
{---------------------------------[ PUBLIC ]-----------------------------------}
procedure TFormApiListarPedidos.Mostra(Leiaute: TLayout);
begin
  Self.TabControlAPI.ActiveTab := TabItemPedidos;
  Self.LayoutApiPedidos.Parent := Leiaute;
end;
