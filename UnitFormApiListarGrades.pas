...
type
  TFormApiListarGrades = class(TForm)
    LayoutApiListarGrandes: TLayout;
    ...
    FDMemTableGrades: TFDMemTable;
    ActionListApiListarGrades: TActionList;
...
var
  FormApiListarGrades: TFormApiListarGrades;
...
{---------------------------------[ INTERNAL ]---------------------------------}
procedure TFormApiListarGrades.ImageEngrenagemClick(Sender: TObject);
begin
  Self.ActionVoltar.Execute;
end;

{---------------------------------[ ACTION ]-----------------------------------}
procedure TFormApiListarGrades.ActionRequestExecute(Sender: TObject);
begin
  Self.ExecutaSolicitacaoHttpGet;
end;

procedure TFormApiListarGrades.ActionVoltarExecute(Sender: TObject);
begin
  Self.LayoutApiListarGrandes.Parent := Self;
end;

{---------------------------------[ PRIVATE ]----------------------------------}
procedure TFormApiListarGrades.ExecutaSolicitacaoHttpGet;
var
...
begin
  ...
  Self.FDMemTableGrades.Active            := False;
...
{---------------------------------[ PUBLIC ]-----------------------------------}
procedure TFormApiListarGrades.Mostra(Leiaute: TLayout);
begin
  Self.TabControlAPI.ActiveTab        := TabItemListaGrades;
  Self.LayoutApiListarGrandes.Parent  := Leiaute;
end;
