...
type
  TFormApiProdutoImagem = class(TForm)
    LayoutApiProdutoImagem: TLayout;
    ...
    FDMemTableProdutoImagem: TFDMemTable;
    ActionListApiProdutoImagem: TActionList;
...
var
  FormApiProdutoImagem: TFormApiProdutoImagem;
...
{---------------------------------[ INTERNAL ]---------------------------------}
procedure TFormApiProdutoImagem.ImageEngrenagemClick(Sender: TObject);
begin
  Self.ActionVoltar.Execute;
end;

{---------------------------------[ ACTION ]-----------------------------------}
procedure TFormApiProdutoImagem.ActionRequestExecute(Sender: TObject);
begin
  Self.ExecutaSolicitacaoHttpGet;
end;

procedure TFormApiProdutoImagem.ActionVoltarExecute(Sender: TObject);
begin
  Self.LayoutApiProdutoImagem.Parent := Self;
end;

{---------------------------------[ PRIVATE ]----------------------------------}
procedure TFormApiProdutoImagem.ExecutaSolicitacaoHttpGet;
var
...
begin
  ...
  Self.FDMemTableProdutoImagem.Active   := False;
...
{---------------------------------[ PUBLIC ]-----------------------------------}
procedure TFormApiProdutoImagem.Mostra(Leiaute: TLayout);
begin
  Self.TabControlAPI.ActiveTab        := TabItemListaGrades;
  Self.LayoutApiProdutoImagem.Parent := Leiaute;
end;
