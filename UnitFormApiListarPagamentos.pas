...
unit UnitFormApiListarPagamentos;
...
type
  TFormApiListarPagamentos = class(TForm)
    LayoutApiPagamento: TLayout;
...
var
  FormApiListarPagamentos: TFormApiListarPagamentos;
...
{---------------------------------[ INTERNAL ]---------------------------------}
procedure TFormApiListarPagamentos.ImageEngrenagemClick(Sender: TObject);
begin
  Self.ActionVoltar.Execute;
end;

{---------------------------------[ ACTION ]-----------------------------------}
procedure TFormApiListarPagamentos.ActionRequestExecute(Sender: TObject);
begin
  Self.ExecutaSolicitacaoHttpGet;
end;

procedure TFormApiListarPagamentos.ActionVoltarExecute(Sender: TObject);
begin
  Self.LayoutApiPagamento.Parent := Self;
end;

{---------------------------------[ PRIVATE ]----------------------------------}
procedure TFormApiListarPagamentos.ExecutaSolicitacaoHttpGet;
var
  BaseURL, UriListarCategorias: string;
  chave, valor: String;
begin
  Self.TabControlAPI.ActiveTab  := Self.TabItemPagamento;
  BaseURL                       := Self.EditURL.Text;
  UriListarCategorias           := Self.EditURI.Text;

  Self.RESTResponseDataSetAdapter1.Active := False;
  Self.FDMemTablePagamento.Active         := False;
...
{---------------------------------[ PUBLIC ]-----------------------------------}
procedure TFormApiListarPagamentos.Mostra(Leiaute: TLayout);
begin
  Self.TabControlAPI.ActiveTab    := TabItemPagamento;
  Self.LayoutApiPagamento.Parent  := Leiaute;
end;
